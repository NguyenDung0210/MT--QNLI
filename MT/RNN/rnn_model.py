...
class RNNModel(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_dim, output_size, n_layers, bidirectional, dropout):
    ...
    def forward(self, input_ids, hidden):
        ...
        lstm_out = lstm_out.contiguous().view(-1, self.hidden_dim * (2 if self.lstm.bidirectional else 1))
