...
def train_model(model, train_dataloader, val_dataloader, test_dataloader, epochs, learning_rate, device):
    ...
    with open(r"Final Prj\QNLI\RNN\RNN_training_log4.txt", "w") as f:
        ...
        for epoch in range(epochs):
            ...
            hidden = model.init_hidden(train_dataloader.batch_size, device)
...
def evaluate_model(model, val_dataloader, device, criterion):
    ...
    hidden = model.init_hidden(val_dataloader.batch_size, device)
